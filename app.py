...
def main():
    ...
    if st.session_state.schema:
        ...
        # Set up LLM chain using Ollama with Mistral
        try:
...
st.markdown("""
<div class="footer">
© Made by Unnikrishnan Nambiar
    <div class="social-links">
        <a href="" target="_blank"><i class="fab fa-instagram"></i></a>
        <a href="https://www.linkedin.com/in/unnikrishnanbnambiar/" target="_blank"><i class="fab fa-linkedin"></i></a>
